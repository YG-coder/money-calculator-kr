...
const FAQ = [
  {
    ...
    a: "둘 중 낮은 쪽입니다. LTV는 담보(주택) 기준 한도이고 DSR은 소득 기준 한도입니다. 이 계산기는 담보 축만 계산하므로, 소득 대비 한도는 DSR 계산기에서 함께 확인하세요. 실제 승인 금액은 여기에 더해 소득 인정 방식, 기존 부채 산정 방식, 금융회사 내부 심사 기준에 따라 더 낮아질 수 있습니다.",
  },
  {
        ...
        guide={
          <>
            ...
            <p>
              ...
              <strong>소득 기준 한도</strong>이고 실제 한도는 둘 중 낮은 쪽입니다.
            </p>
